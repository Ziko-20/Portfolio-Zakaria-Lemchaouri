...
export default function Projects() {
  ...
  const allProjects = [
    ...
    {
      id: 7, title: t('projects.items.p7_title'), category: 'web',
      categoryLabel: t('projects.categories.web'),
      description: t('projects.items.p7_desc'), image: '/projet-meteo.png',
      tags: ['React 19', 'Vite', 'Open-Meteo API', 'Vercel'],
      liveLink: 'https://weather-app-eight-liart-61.vercel.app/',
      githubLink: 'https://github.com/Ziko-20/Weather-app.git',
      accentColor: '#0ea5e9', inProgress: false,
    },
    {
      id: 8, title: t('projects.items.p8_title'), category: 'fullstack',
      categoryLabel: t('projects.categories.fullstack'),
      description: t('projects.items.p8_desc'), image: '/LetsMeet.png',
      tags: ['Laravel', 'Blade', 'Livewire', 'MySQL'],
      liveLink: 'https://github.com/Ziko-20',
      githubLink: 'https://github.com/Ziko-20',
      accentColor: '#7c3aed', inProgress: true,
    },
    {
