  ...
  fr: {
    translation: {
      ...
      about: {
        ...
        p1: "Développeur Web Full-Stack Junior, diplômé en Développement Digital de la <strong class='font-bold text-zinc-900'>Cité des Métiers et des Compétences (CMC) Rabat</strong>, après avoir effectué ma première année à <strong class='font-bold text-zinc-900'>l'ISTA NTIC Rabat</strong>, je suis passionné par la création d'applications web modernes, intuitives et utiles. J'aime transformer des idées en projets concrets tout en accordant une grande importance à la qualité, à l'expérience utilisateur et à l'apprentissage continu.",
        p2: "Curieux, autonome et motivé, je cherche constamment à développer mes compétences à travers de nouveaux défis et des projets personnels. Mon objectif est d'intégrer une équipe où je pourrai apprendre, contribuer à des projets ambitieux et évoluer aussi bien sur le plan professionnel que personnel.",
  ...
  en: {
    translation: {
      ...
      about: {
        ...
        title2: " web apps.",
        p1: "Junior Full-Stack Web Developer, graduated in Digital Development from the <strong class='font-bold text-zinc-900'>Cité des Métiers et des Compétences (CMC) Rabat</strong>, after completing my first year at <strong class='font-bold text-zinc-900'>ISTA NTIC Rabat</strong>, I am passionate about creating modern, intuitive, and useful web applications. I love transforming ideas into concrete projects while placing great importance on quality, user experience, and continuous learning.",
        p2: "Curious, autonomous, and motivated, I constantly seek to develop my skills through new challenges and personal projects. My goal is to join a team where I can learn, contribute to ambitious projects, and grow both professionally and personally.",
        softSkillsTitle: "Soft Skills",
  ...
  de: {
    translation: {
      ...
      about: {
        ...
        title2: " von Web-Apps.",
        p1: "Junior Full-Stack Webentwickler, Absolvent in digitaler Entwicklung der <strong class='font-bold text-zinc-900'>Cité des Métiers et des Compétences (CMC) Rabat</strong>, nach meinem ersten Jahr am <strong class='font-bold text-zinc-900'>ISTA NTIC Rabat</strong>. Ich begeistere mich für die Erstellung moderner, intuitiver und nützlicher Webanwendungen. Ich liebe es, Ideen in konkrete Projekte zu verwandeln, und lege dabei großen Wert auf Qualität, Benutzererfahrung und kontinuierliches Lernen.",
        p2: "Neugierig, selbstständig und motiviert suche ich ständig nach Möglichkeiten, meine Fähigkeiten durch neue Herausforderungen und persönliche Projekte weiterzuentwickeln. Mein Ziel ist es, ein Team zu bereichern, in dem ich lernen, zu ambitionierten Projekten beitragen und mich sowohl beruflich als auch persönlich weiterentwickeln kann.",
        softSkillsTitle: "Soft Skills",
